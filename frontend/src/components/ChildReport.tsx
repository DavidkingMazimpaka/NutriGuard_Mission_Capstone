...
const ChildReport = ({ childId, childName, measurements, status }: ChildReportProps) => {
  ...
  const getStatusText = (status: "normal" | "warning" | "danger") => {
    switch (status) {
      ...
      case "danger":
        return "High Risk - Urgent Action Required";
      default:
  ...
  const handleDownload = async () => {
    try {
      ...
      const opt = {
        margin: 1,
        filename: `${childName}_Nutrition_Report_${new Date().toISOString().split('T')[0]}.pdf`,
  ...
  const handleShare = () => {
    const subject = `Nutritional Assessment Report for ${childName}`;
    const body = `
Nutritional Assessment Report for ${childName}
...
Latest Measurements:
- Weight: ${measurements[0].weight}kg
- Height: ${measurements[0].height}cm
- Weight-for-Age: ${measurements[0].weightForAge.toFixed(1)}
...
Generated by NutriGuard - Child Nutrition Monitoring System
    `.trim();
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="print:block" id="printable-report">
          <div className="flex justify-between items-center mb-6 print:mb-8">
            ...
            <div className={`px-4 py-2 rounded-md print:bg-gray-200 print:text-black ${
              status === "danger" 
          ...
          <div className="mb-6 print:mb-8">
            ...
            <Card className="p-4">
              <p className="mb-2">
                <strong>Current Status:</strong> {getStatusText(status)}
              </p>
              <p className="mb-2">
            ...
            <Card className="p-4">
              ...
              {status === "normal" && (
                <div className="bg-green-50 text-green-700 p-4 rounded-lg">
                  <h3 className="font-semibold">Low Risk Status</h3>
                  <p>Continue with regular monitoring and maintain current nutritional practices.</p>
                </div>
              )}
            </Card>
          </div>
